...
protocol MessageServiceDelegate: AnyObject {
    ...
    /// receive custom command: gift or invitation
...
class MessageService {
    ...
    func sendTextMessage(_ message: String, callback: CommonHandler) {
        
    }
    
    /// send an invitation message to user to take a speaker seat
    func sendInvitation(_ userID: String, callback: CommonHandler) {
